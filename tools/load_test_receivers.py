"""Synthetic multi-Store load test for the SpeakLink broadcast path.
...
The protected database backend/speaklink_live.db is never used.
"""
...
class SyntheticReceiver:
    ...
    async def _on_audio_control(self, payload: dict, session_id: int | None) -> None:
        ...
        if not self.supports_audio_control or not self.endpoint_configured:
            ...
            # whoever moved it - including SpeakLink. Without this the harness
