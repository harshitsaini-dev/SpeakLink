...
def resolve_persistent_root() -> Path:
    ...
    return base / "SpeakLink" / PERSISTENT_ROOT_NAME
...
class ServerProfile:
    ...
    def database(self) -> Path:
        return self.root / "data" / "speaklink.db"
    ...
    def require_not_throwaway(self, database_path) -> None:
        ...
        if is_throwaway_pilot_database(database_path):
            raise PersistentServerError(
                ...
                "that folder. Run Initialize-SpeakLinkPersistentLanServer.ps1 and "
