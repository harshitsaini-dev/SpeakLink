...
Bluetooth link, audible Store speakers, LinkGuard or SPEAKER_VERIFIED.
...
def smoke(paths) -> dict:
    ...
    try:
        ...
        receiver_environment["SPEAKLINK_RECEIVER_TOKEN"] = receiver_token
        ...
        # SPEAKER_VERIFIED must never appear: LinkGuard is not part of this task
