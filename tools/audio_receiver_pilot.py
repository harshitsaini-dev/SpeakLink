...
def hidden_child_process_options() -> dict:
    ...
    ``EchoCastReceiverBackground.exe`` is built GUI-subsystem, so it has no
...
class AudioReceiverPilot:
    ...
    async def _prepare_windows_endpoint(self, connection) -> "bool | None":
        ...
        # Observation begins HERE and ends at restoration: EchoCast has no
    ...
    def restore_windows_endpoint(self) -> dict:
        ...
        """
        # Detach the observer FIRST. Once this broadcast is over EchoCast has
