...
class WindowsPcmSink:
    ...
    def __init__(self, configuration: SinkConfiguration, *, backend=None) -> None:
        ...
        # SpeakLink's OWN output level, applied to the decoded samples on their
        # way to the device.
        #
        ...
        #     not turn down LinkGuard, the till software, or whatever else
        ...
        #
        # The cost is that it scales SpeakLink's audio only. That is exactly the
