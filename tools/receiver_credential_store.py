...
DPAPI_ENTROPY = b"SpeakLink/receiver-device-credential/v1"
...
def default_credential_path() -> Path:
    ...
    return Path(base) / "SpeakLink" / "receiver" / "device-credential.bin"
