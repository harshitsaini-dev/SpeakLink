...
The security audit found the live ``JWT_SECRET`` inside ``speaklink-live.zip`` in
...
#: 48 bytes url-safe, matching what Start-SpeakLinkPersistentLanServer.ps1 already
...
SECRET_KEYS = frozenset({
    ...
    "MONGO_URL",
    "SECRET_KEY",
    "SPEAKLINK_KEY_PROTECTOR_SECRET",
})
...
def main(argv=None) -> int:
    ...
    print("SPEAKLINK_JWT_SECRET_ROTATED")
