...
PURGED = "ECHOCAST_LEGACY_CATALOG_PURGED"
...
def main(argv=None) -> int:
    ...
    print("=== EchoCast legacy catalog purge ===")
    ...
    before = database.parent.parent / "backups" / f"echocast-before-legacy-purge-{stamp}.db"
    ...
    after = database.parent.parent / "backups" / f"echocast-after-legacy-purge-{stamp}.db"
