...
class ReceiverConfig:
    ...
    #: changes and would point EchoCast at the wrong output. None means an
...
def _run_locked(arguments, *, ws_url: str, path: Path, log: logging.Logger,
    ...
    # EchoCast would end up controlling whatever happened to match today.
    try:
