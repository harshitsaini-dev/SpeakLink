"""Prepare and verify a throwaway EchoCast staging stack on a private LAN.
...
def reject_protected_paths(pilot_root: Path) -> None:
    ...
    pilot_environment = os.environ.get("ECHOCAST_PILOT_ROOT", "").strip()
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="lan_pilot",
        description=(
            "Prepare or verify a throwaway EchoCast staging stack bound to a "
