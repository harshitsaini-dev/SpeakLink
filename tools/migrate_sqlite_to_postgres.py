#!/usr/bin/env python
"""Migrate SpeakLink's SQLite database to PostgreSQL (Supabase), preserving
...
SEQUENCE_TABLES = [
    ...
    "store_deletion_events", "receiver_enrollment_codes", "broadcast_sessions",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--sqlite-path", required=True, type=Path,
                        help="Path to the source speaklink.db (opened read-only)")
