...
REM
REM     scripts\Build-SpeakLinkReceiver.ps1
REM     scripts\Test-SpeakLinkReceiverPackage.ps1
REM     scripts\Build-SpeakLinkStoreSetupPackage.ps1
REM
REM Output: artifacts\SpeakLink-Store-Kit-<version>-<commit>-<timestamp>.zip
REM ===========================================================================
setlocal
