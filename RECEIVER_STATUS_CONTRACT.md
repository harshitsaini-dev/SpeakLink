# EchoCast Receiver Status and Acknowledgement Contract

Version: `1.0`

Status: pure contract implemented; runtime integration is pending

This contract defines how EchoCast describes receiver health without confusing
...
- `SPEAKER_VERIFIED`: EchoGuard, through the separate trusted-verifier path,
...
common envelope, a matching `session_id`, and `source="echoguard"`. Ordinary
receiver parsing rejects this message type. This reservation defines no
EchoGuard transport or API.
...
- No EchoGuard API or transport design.
