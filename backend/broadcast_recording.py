...
EchoGuard monitoring or shop conversation: none of those ever travel on this
...
logger = logging.getLogger("echocast.recording")
...
def recordings_directory(repository_root: Path | None = None) -> Path:
    ...
    """
    configured = os.environ.get("ECHOCAST_DATA_DIR", "").strip()
    if configured:
