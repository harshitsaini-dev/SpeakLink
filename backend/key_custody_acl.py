...
local account ``SpeakLinkService``, CURRENT_USER scope under that account, and the
container at ``C:\\ProgramData\\SpeakLink\\keys\\receiver-hmac-keys.bin``.
...
need elevation and live in ``scripts/Install-SpeakLinkServiceIdentity.ps1``.
"""
