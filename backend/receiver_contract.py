...
class EndpointStateAcknowledgement(AcknowledgementBase):
    ...
    volume or mute changes, whoever caused it - EchoCast, the taskbar, the
...
def parse_trusted_verifier_event(payload: object) -> TrustedSpeakerVerifiedEvent:
    """Parse the separate EchoGuard/acoustic-verifier message contract."""
