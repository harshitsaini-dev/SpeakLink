"""One authoritative place that decides which database SpeakLink talks to.
...
DEFAULT_SQLITE_PATH = Path(__file__).resolve().parent / "speaklink_live.db"
...
def _sqlite_config() -> DatabaseConfig:
    configured = os.environ.get("SPEAKLINK_DB_PATH")
    path = (
