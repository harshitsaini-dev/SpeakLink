...
_DEFAULT_DATA_DIR = Path(tempfile.gettempdir()) / f"speaklink-tests-data-{_WORKER}"
_configured_data = os.environ.get("SPEAKLINK_DATA_DIR")
if (not _configured_data
    ...
    os.environ["SPEAKLINK_DATA_DIR"] = str(_DEFAULT_DATA_DIR)
