...
ROTATED = "echocast_rcv_v1.11111111-2222-4333-8444-555555555555." + "r" * 43
...
def test_the_default_path_is_the_agreed_one(monkeypatch):
    ...
    assert default_credential_path() == Path(
        r"C:\Users\someone\AppData\Local\EchoCast-AI\receiver\device-credential.bin"
    )
...
def test_the_protected_database_is_never_touched(path: Path, protector):
    protected = REPOSITORY_ROOT / "backend" / "echocast_live.db"
