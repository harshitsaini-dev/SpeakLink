...
EchoCast briefly grew a dedicated always-on Master Volume console: a separate
...
broadcast is running, EchoCast does not touch a Store's Windows mixer at all.**
