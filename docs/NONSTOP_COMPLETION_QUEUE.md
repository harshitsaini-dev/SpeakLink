...
| Task start/stop/status seam | `AUTOMATED PASS` | `Manage-EchoCastStoreReceiverTask.ps1`; 9 tests, incl. staged Start/Stop both refusing an impostor task |
...
| `EchoCastStoreSetup.exe` rebuilt from current source | `AUTOMATED PASS` | PE subsystem 2; launched, real window, 0 new conhost processes |
