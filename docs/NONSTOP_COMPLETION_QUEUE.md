...
| 7 | `EchoCastHQRuntime.exe` supervisor | `AUTOMATED PASS` | `tools/hq_runtime.py` + `hq_runtime.spec`; built, PE Subsystem 2 read from the file; 26 tests |
| 7 | HQ auto-start scripts + package | `NOT STARTED` | Install/Test/Repair/Uninstall-EchoCastHQAutoStart.ps1 and the versioned package do not exist |
