...
**`speaklink-live.zip`** (repository root, dated 7 July) contains `backend/.env`.
...
| 3. Delete `speaklink-live.zip` | done on explicit operator approval, exact literal path, SHA-256 confirmed first |
...
> Related, lower severity: `backups/speaklink_live-20260729-160359.db` is a full
...
**Was:** `Start-SpeakLinkPersistentLanServer.ps1:125` ended in a backtick
