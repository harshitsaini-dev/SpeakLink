# SpeakLink Receiver Credential Production Cutover Runbook
...
The default SpeakLink application remains legacy Store-token-only. The current
...
- LinkGuard/acoustic-verifier interaction risk and owner
...
9. Verify actual speaker output only through LinkGuard or another trusted
...
- SPEAKER_VERIFIED comes only from LinkGuard/trusted acoustic verification.
...
- LinkGuard overlap or emergency-announcement risk is unresolved
