...
| `SPEAKER_VERIFIED` | No — needs LinkGuard/acoustic evidence |
...
python tools\load_test_receivers.py --stores 40 --pilot-root "$env:TEMP\speaklink-load" --report "$env:TEMP\load-40.json"
```
