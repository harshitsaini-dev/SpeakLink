@echo off
REM ===========================================================================
REM Restart the SpeakLink HQ instance THIS folder started.
REM
...
REM 
REM
REM A THIN WRAPPER - the logic lives in tools\speaklink_server.py.
REM ===========================================================================
setlocal
...
"%PYTHON%" "%REPO%tools\speaklink_server.py" restart
