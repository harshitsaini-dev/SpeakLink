...
STEP 7 - install it as the background Store Receiver
    ...
    .\Installer\Install-SpeakLinkStoreReceiver.ps1 ``
...
STEP 8 - check it
    ...
    .\Installer\Test-SpeakLinkStoreReceiver.ps1

  Expect SPEAKLINK_STORE_RECEIVER_VERIFIED.
...
IF SOMETHING LOOKS WRONG
    ...
    .\Receiver\SpeakLinkReceiver.exe diagnose
...
TO REPAIR OR UPGRADE (keeps this computer enrolled, keeps your settings)
    ...
    .\Installer\Repair-SpeakLinkStoreReceiver.ps1 -PackagePath .\Receiver

TO REMOVE EVERYTHING

    .\Installer\Uninstall-SpeakLinkStoreReceiver.ps1
