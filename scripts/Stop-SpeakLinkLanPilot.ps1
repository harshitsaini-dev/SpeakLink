...
Write-Output '=== stopping the SpeakLink private LAN pilot ==='
...
foreach ($name in 'ADMIN_PASSWORD','JWT_SECRET','ADMIN_USERNAME','SPEAKLINK_DB_PATH',
                  'SPEAKLINK_KEY_CONTAINER','SPEAKLINK_KEY_PROTECTOR','CORS_ORIGINS',
...
$protected = Join-Path (Split-Path -Parent $PSScriptRoot) 'backend\speaklink_live.db'
