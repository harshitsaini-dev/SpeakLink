...
.SYNOPSIS
    ...
    actually run the backend. Run this AS EchoCastService.
...
param(
    ...
    [string] $KeyFile = 'C:\ProgramData\EchoCast-AI\keys\receiver-hmac-keys.bin',
...
Write-Output '=== EchoCast Receiver key custody, under the running identity ==='
