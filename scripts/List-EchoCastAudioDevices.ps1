<#
.SYNOPSIS
    List Windows audio OUTPUT devices for the EchoCast one-Store pilot.
...
.DESCRIPTION
    ...
    as ECHOCAST_AUDIO_OUTPUT_DEVICE. The pilot never picks a device for you.
...
Write-Output '=== EchoCast Windows audio OUTPUT devices (read-only) ==='
Write-Output ''
