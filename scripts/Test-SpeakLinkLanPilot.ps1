...
Write-Output '=== SpeakLink private LAN pilot verification ==='
...
$protected = Join-Path $repositoryRoot 'backend\speaklink_live.db'
...
if ($failed.Count -eq 0) {
    Write-Output 'Result: SPEAKLINK_PRIVATE_LAN_PILOT_VERIFIED'
