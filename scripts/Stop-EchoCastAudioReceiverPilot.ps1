...
.DESCRIPTION
    ...
    really is the EchoCast audio Receiver pilot before touching it, stops it
...
if ([string]$process.CommandLine -notlike '*audio_receiver_pilot.py*') {
    Write-Output "  Process $processId does NOT look like the EchoCast audio Receiver pilot."
