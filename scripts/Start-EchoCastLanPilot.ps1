<#
.SYNOPSIS
    Start a throwaway EchoCast staging stack on the private LAN.
...
# ---------------------------------------------------------------------------
Write-Output '=== EchoCast private LAN pilot ==='
Write-Banner
...
$pilotRoot = Join-Path $env:LOCALAPPDATA "EchoCast-AI\lan-pilot\$(Get-Date -Format 'yyyyMMdd-HHmmss')"
...
Write-Output ""
Write-Output "Stop it with:  .\scripts\Stop-EchoCastLanPilot.ps1 -PilotRoot '$pilotRoot'"
