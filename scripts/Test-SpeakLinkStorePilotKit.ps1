...
Check 'README-FIRST gives the install command' { $readme -match 'Installer\\Install-SpeakLinkStoreReceiver\.ps1' }
...
Check 'the kit carries the Store runtime scripts' {
    @('Install-SpeakLinkStoreReceiver.ps1', 'Test-SpeakLinkStoreReceiver.ps1',
      'Repair-SpeakLinkStoreReceiver.ps1', 'Uninstall-SpeakLinkStoreReceiver.ps1') |
...
Check 'the kit carries the windowed background executable' {
    Test-Path (Join-Path $receiver 'SpeakLinkReceiverBackground.exe')
}
