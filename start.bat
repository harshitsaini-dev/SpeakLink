@echo off
REM ===========================================================================
REM Start EchoCast HQ from this folder.
REM
REM A THIN WRAPPER. Every decision - configuration, dependency bootstrap, PID
REM ownership, health checking - lives in tools\echocast_server.py, so a Linux
...
"%PYTHON%" "%REPO%tools\echocast_server.py" start
