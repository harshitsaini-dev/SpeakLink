...
test("the console is only the console", async () => {
  // Templates and recordings live on their own pages now. They are used at
  // completely different rates - this many times a day, those once a
  // fortnight - and sharing a screen meant scrolling past the fortnightly
  // thing to reach the hourly one.
  ...
  expect(screen.queryByTestId("template-new")).toBeNull();
});
