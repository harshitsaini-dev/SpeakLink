...
// Emergency Stop is no longer part of this page. It lives in the sidebar, in
// reach from every page, and its tests moved with it to
// src/components/EmergencyStopControl.test.js.
