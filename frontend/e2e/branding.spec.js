...
// The product is SpeakLink. It shipped as "Emergent | Fullstack App",
...
test.describe('SpeakLink branding', () => {
  test('the browser title is exactly SpeakLink', async ({ page }) => {
    await signIn(page);
    await mockBackend(page);
    await page.goto('/console');
    await expect(page).toHaveTitle('SpeakLink');
  });
  ...
  test('the description names the product', async ({ page }) => {
    ...
    expect(description).toContain('SpeakLink');
